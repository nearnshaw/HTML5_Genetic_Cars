...
// if(editMode) {
//     editMode = false;
//     if(typeof cw_drawInterval !== undefined)
//     {
//       clearInterval(cw_drawInterval);
//     }
//     if(typeof cw_runningInterval !== undefined)
//     {
//       clearInterval(cw_runningInterval);
//     }
//     cw_runningInterval = setInterval(leap_simulationStep, 1); // simulate 1000x per second when not drawing
//   } else {
//    editMode = true;
...
function leap_simulationStep()
{
  ...
  // if (leaparray.length > 100)
  // {
  //   bluePrintComplete = true;
  // }

  // if (bluePrintComplete == true)
  // {
  //   alert("bluePrint is complete!");
  //   var car_def = cw_createLeapCar();//param array of coordinates and wheelpos
  //   cw_carGeneration.push(car_def);
  //   leap_end();
...
function cw_createLeapCar()//param array of coordinates and wheelpos
 {
  ...
  car_def.wheel_density2 = Math.random()*wheelMaxDensity+wheelMinDensity;
  car_def.vertex_list = new Array();
  car_def.vertex_list.push(new b2Vec2(2,0));
  car_def.vertex_list.push(new b2Vec2(2,2));
  car_def.vertex_list.push(new b2Vec2(0,2));
  car_def.vertex_list.push(new b2Vec2(-2,2));
  car_def.vertex_list.push(new b2Vec2(-2,0));
  car_def.vertex_list.push(new b2Vec2(-2,-2));
  car_def.vertex_list.push(new b2Vec2(0,-2));
...
{
  var car_def = cw_createLeapCar();//param array of coordinates and wheelpos
  var leap_def = cw_carGeneration.push(car_def);
  leap_end();
  cw_createLeapCar();
  startThisShit(leap_def);
